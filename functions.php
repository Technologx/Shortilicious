...
function db_ins_die($filename, $line, $message) {
    die('<p style="color:#FE2E2E;">Shortilicious Installation Wizard failed to connect to the database using the specified credentials. Please go back and try again.</p>');
}
