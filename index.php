<?php
define('Shortilicious', true);
ini_set('display_errors', 0);
$prefix[0] = '';
$filename = 'install';
if (is_dir($filename)) {
    die ("<body bgcolor='#000'><font color='#00BAFF'>To get Shortilicious up and running, you first need to go through the <a href=\"install\">installation wizard</a> which will help you set up your new URL shortener in a matter of moments.<br/><br/>If you've already installed Shortilicious, then you MUST delete the install directory before it will function.</font></body>");
}
?>
<?php
